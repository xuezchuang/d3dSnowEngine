...
int main()
{
	if (0)
	{
		char Path[] = "P:\\RenZhaiEngine\\RZBuildTool\\TestObject.h";
		char PathH[] = "P:\\RenZhaiEngine\\RZBuildTool\\TestObject.G.h";
		char PathCPP[] = "P:\\RenZhaiEngine\\RZBuildTool\\TestObject.G.cpp";
