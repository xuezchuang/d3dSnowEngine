...
void Atmospheric::OnRender(FCommandContext& CommandContext)
{
...
void Atmospheric::ScatteringPassCS(FCommandContext& GfxContext)
{
...
void Atmospheric::ScatteringPassPS(FCommandContext& GfxContext)
{
...
void Atmospheric::PostProcess(FCommandContext& GfxContext)
{
	if(m_bUseComputeShader)
	{
