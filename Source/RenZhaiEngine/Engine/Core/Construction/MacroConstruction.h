...
#define CREATE_SKINNED_RENDER_DATA(T,...)\
ActorMeshConstruction::CreateSkinnedMeshRenderData<T>(GetMeshManage(), this, __VA_ARGS__);
...
#define CREATE_SKINNED_RENDER_DATA_BY_COMPONENT(T,Component,...)\
ActorMeshConstruction::CreateSkinnedMeshRenderDataByComponent<T>(GetMeshManage(), dynamic_cast<T*>(Component) , __VA_ARGS__);
