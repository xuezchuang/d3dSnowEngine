...
//	void OnStartup();
//	void OnUpdate();
//	void OnRender(GraphicsContext& CommandContext);
//
//	FCamera* m_Camera;
//	GameDesc* m_GameDesc;
//private:
...
//	void ScatteringPassCS(GraphicsContext& GfxContext);
//	void ScatteringPassPS(GraphicsContext& GfxContext);
//	void PostProcess(GraphicsContext& GfxContext);
//
//private:
...
//	GraphicsPSO m_ScatteringPSPSO;
//	GraphicsPSO m_PostPSO;
//
...
//private:
//	void OnGUI(GraphicsContext& CommandContext);
//	void OnTest(GraphicsContext& CommandContext);
